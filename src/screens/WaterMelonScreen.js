...
const WaterMelonScreen = ({ navigation }) => {
  return (
    <>
      ...
      <View>
        ...
        <Image
          ...
          source={require("../assets/melonn.png")}
        />
        <View style={styles.priceContainer}>
          <View style={[styles.priceButton, { flexDirection: "row" }]}>
            <Text style={styles.priceText}>Rs. 180</Text>
          </View>
          <FontAwesome
            name="heart"
            size={24}
        ...
        <Text style={styles.bodyText}>
          What did the smartphone say to the watermelon? "You're one in a
          "melon"!"
        </Text>
