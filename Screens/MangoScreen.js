    ...
    <>
      ...
      <View>
        ...
        <Image
          ...
          source={require("../assets/mangoess.png")}
        />
        <View style={styles.priceContainer}>
          <View style={[styles.priceButton, { flexDirection: "row" }]}>
            <Text style={styles.priceText}>Rs. 300</Text>
          </View>
          <FontAwesome
            name="heart"
            size={24}
        ...
        <Text style={styles.bodyText}>
          What did the programmer say to the mango? "Can I take a "byte" out of
          you?"
        </Text>
        ...
        >
          ...
          <ProgressCircle
            ...
            style={styles.circe}
          >
            <Text style={{ fontSize: 18 }}>{"92"}</Text>
          </ProgressCircle>
        </View>
